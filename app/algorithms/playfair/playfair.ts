...
export function generatePlayfairKey(key: string): string[][] {
  ...
  export function playfairDecrypt(ciphertext: string, key: string): string {
    ...
    return plaintext.replace(/X/g, ''); // Optionally remove padding character
  }
  ...
  // console.log('Encrypted:', encrypted); // Example: "GATLM ZMEVL"
  
  // const decrypted = playfairDecrypt(encrypted, key);
  // console.log('Decrypted:', decrypted); // Expected: "HELLOWORLD"
  

// console.log(playfairEncrypt("HELLO", "KEYWORD")); // DMLOOX